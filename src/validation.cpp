...
/* Catoshi: Undo{Read|Write)FromDisk moved to undo.cpp */
...
#if defined(FEATURE_INDEX) // TODO: remove me?
...
// Catoshi: FEATURE_INDEX }
    ...
    if (!control.Wait()){
#if 1 || defined(FEATURE_VERBOSE)
        LogPrintf("CheckQueue failed block\n %s\n", block.ToString());
#endif
...
/* Catoshi: coin.cpp needs this, so put prototype in validation.h */
