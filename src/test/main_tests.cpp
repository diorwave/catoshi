...
#if defined(BRAND_bitcoin) || defined(BRAND_litecoin)
...
#else
#warning "implement this for COIN_BRAND"
#endif
...
BOOST_AUTO_TEST_CASE(subsidy_limit_test)
{
    ...
    BOOST_CHECK_EQUAL(nSum, 100194250000000ULL);
#else
#error "implement subsidty_limit test"
#endif
}
